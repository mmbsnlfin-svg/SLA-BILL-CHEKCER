...
def create_pdf_note(output_path, title, text_body, generated_at):
    """
    ...
    def _draw_footer(canvas, doc_obj):
        ...
        canvas.line(24, 27, A4[0] - 24, 27)
        canvas.setFont("Helvetica", 7.5)
        canvas.setFillColor(colors.grey)
        footer_text = f"Generated by BSNL SLA Bill Checker | V{SOFTWARE_VERSION} | {generated_at}"
...
"""
    ...
    summary = pd.DataFrame([
        ["Software Version", f"V{SOFTWARE_VERSION}"],
    ...
    create_pdf_note(out_accounts_pdf, "OFFICE NOTE", accounts_note, generated_at)
    create_pdf_note(out_tech_pdf, "SLA PENALTY NOTE", technical_note_clause14, generated_at)
