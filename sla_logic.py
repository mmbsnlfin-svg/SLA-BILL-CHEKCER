...
def create_pdf_note(output_path, title, text_body):
    """
    Create a clean, readable PDF note from the existing note text.
    Landscape A4 + Courier font keeps table alignment readable and printable.
    """
    ...
    # Landscape A4 allows longer aligned note lines without tiny font.
    story.append(Preformatted(str(text_body), mono_style, maxLineLength=145))
